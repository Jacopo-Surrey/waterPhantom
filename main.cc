...
int main(int argc, char** argv)
{
  ...
  // NOT NEEDED anymore
  //G4String defaultDetector = "MicroDiamond"; 
  //DetectorConstruction* detector = new DetectorConstruction(analysis, defaultDetector);  
  
  // geometry messenger (stores and changes settings for the detector construction)
  DetectorMessenger* detMess = new DetectorMessenger(analysis);	//USELESS HERE
